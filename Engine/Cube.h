...
public:
	template<class V>
	static IndexTriangleList<V> GetPlain(float size = 1.0f)
	{
	...
	template<class V>
	static IndexTriangleList<V> GetIndependentFacesNormals(float size = 1.0f)
	{
	...
	template<class V>
	static IndexTriangleList<V>GetPlainIndependentFaces(float size = 1.0f) {
		const float side = size / 2.0f;
