...
public:
	template<class V>
	static IndexTriangleList<V> GetPlain(int divisions_x = 7, int divisions_y = 7, float width = 1.0f, float height = 1.0f)
	{
	...
	template<class V>
	static IndexTriangleList<V> GetSkinned(int divisions_x = 7, int divisions_y = 7, float width = 1.0f, float height = 1.0f, float tScale = 1.0f)
	{
	...
	template<class V>
	static IndexTriangleList<V> GetNormals(int divisions_x = 7, int divisions_y = 7, float width = 1.0f, float height = 1.0f) {
		auto itList = GetPlain<V>(divisions_x, divisions_y, width, height);
